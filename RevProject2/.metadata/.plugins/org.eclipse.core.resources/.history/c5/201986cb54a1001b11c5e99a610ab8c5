...
public class UsersController {
	...
	@GetMapping("/users/{id}")
	public ResponseEntity<Users> getUserById(@PathVariable(value = "user_id") long user_id)
	...
	@PutMapping("/users/{id}")
	public ResponseEntity<Users> updateUser(@PathVariable(value = "user_id") long user_id,
